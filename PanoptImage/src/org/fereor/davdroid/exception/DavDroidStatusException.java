...
public class DavDroidStatusException extends DavDroidException {
	public DavDroidStatusException(String message) {
		super(message);
	}

	public DavDroidStatusException(String message, int statusCode,
			String reasonPhrase) {
