...
/**
 * Interface of objects which can be serialized
 * @author "arnaud.p.fereor"
 *
 */
public interface DavInput extends DavIO {
	/**
	 * Serialize opbject using serializer
	 * @param serializer Xml serializer to use
	 * @return serialised object
	 * @throws IOException 
	 */
	void writeself(XmlSerializer serializer) throws IOException;
}
