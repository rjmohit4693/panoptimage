...
public class Lockdiscovery {
	...
	/*
	 * @ElementList protected List<Activelock> activelock;
	 *//**
	 ...
	 */
	/*
	 * public List<Activelock> getActivelock() { if (activelock == null) {
	 * activelock = new ArrayList<Activelock>(); } return this.activelock; }
	 */
