...
public class Supportedlock {
	...
	/*
	 * @ElementList protected List<Lockentry> lockentry;
	 *//**
	 ...
	 */
	/*
	 * public List<Lockentry> getLockentry() { if (lockentry == null) {
	 * lockentry = new ArrayList<Lockentry>(); } return this.lockentry; }
	 */
}
